...
var _noteMap = _interopRequireDefault(require("./noteMap.js"));
...
const analyze = midi => {
  ...
  console.log(`MIDI File Format Type: ${midi.header.getFormat()}`); // outputMidi.header.setTicksPerBeat(midi.header.getTicksPerBeat());
  ...
  for (let index = 0; index < midi.tracks.length; index++) {
    ...
    let newTrackEvents = trackEvents.map(event => {
      ...
      if (event.type == _midievents.default.EVENT_MIDI && event.subtype == _midievents.default.EVENT_MIDI_PROGRAM_CHANGE) {
        // event.param1 = 0;
        ...
        return 99;
      } else if (event.type == _midievents.default.EVENT_MIDI && (event.subtype == _midievents.default.EVENT_MIDI_NOTE_OFF || event.subtype == _midievents.default.EVENT_MIDI_NOTE_ON)) {
        ...
        return event;
      } else if (event.type == _midievents.default.EVENT_MIDI && event.subtype == _midievents.default.EVENT_MIDI_CONTROLLER) {
        ...
        // console.log(event);
        return event;
      } else if (event.type == _midievents.default.EVENT_META && event.subtype == _midievents.default.EVENT_META_END_OF_TRACK) {
        // the end of a track is signalled by an event of type 0xff and subtype 0x2f.
        // console.log(`End of track event:`);
        // console.log(event);
        return event;
      } else if (event.type == _midievents.default.EVENT_META && event.subtype == _midievents.default.EVENT_META_TRACK_NAME) {
        // track names are in events of type 0xff and subtype 0x3.
        return 99;
      } else if (event.type == _midievents.default.EVENT_META && event.subtype == _midievents.default.EVENT_META_SET_TEMPO) {
        ...
        console.log(event);
        return event;
      } else if (event.type == _midievents.default.EVENT_META && event.subtype == _midievents.default.EVENT_META_MARKER) {
        ...
        return 99;
      } else if (event.type == _midievents.default.EVENT_META && event.subtype == _midievents.default.EVENT_META_COPYRIGHT_NOTICE) {
        // a copyright notice. type 0xff, subtype 0x02.
        return 99;
      } else if (event.type == _midievents.default.EVENT_META && event.subtype == _midievents.default.EVENT_META_TIME_SIGNATURE) {
        ...
        console.log(event);
        return event;
      } else if (event.type == _midievents.default.EVENT_META && event.subtype == _midievents.default.EVENT_META_KEY_SIGNATURE) {
        ...
        console.log(event);
        return event;
      } else if (event.type == _midievents.default.EVENT_MIDI && event.subtype == _midievents.default.EVENT_MIDI_PITCH_BEND) {
        // fancy pitch bending. type 0x08, subtype 0xe.
        // console.log(`Pitch bend effect on Track ${index}`);
        return event;
      } else if (event.type == _midievents.default.EVENT_MIDI && event.subtype == _midievents.default.EVENT_MIDI_NOTE_AFTERTOUCH) {
        // fancy note aftertouches. type 0x08, subtype 0xa.
        // console.log(`Note aftertouch effect on Track ${index}`);
        return event;
      } else if (event.type == _midievents.default.EVENT_MIDI && event.subtype == _midievents.default.EVENT_MIDI_CHANNEL_AFTERTOUCH) {
        // fancy channel aftertouches. type 0x08, subtype 0xd.
        // console.log(`Channel effect on Track ${index}`);
        return event;
      } else if (event.type == _midievents.default.EVENT_META) {
        // all other meta events
        // console.log(`Other meta event on Track ${index}`);
        // console.log(event);
        return 99;
      } else if (event.type == _midievents.default.EVENT_SYSEX || event.type == _midievents.default.EVENT_DIVSYSEX) {
    ...
    console.log(`Track ${index} has ${newTrackEvents.length} events.`); // if (index == 0 || index == 4 || index == 5) {
